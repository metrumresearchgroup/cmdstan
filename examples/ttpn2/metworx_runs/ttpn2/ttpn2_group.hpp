...
namespace ttpn2_group_model_namespace {
...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "examples/ttpn2/ttpn2_group.stan");
    reader.add_event(122, 120, "end", "examples/ttpn2/ttpn2_group.stan");
    return reader;
}
...
class ttpn2_group_model
  : public stan::model::model_base_crtp<ttpn2_group_model> {
private:
        int nId;
        int nt;
        int nPNObs;
...
public:
    ttpn2_group_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "ttpn2_group_model_namespace::ttpn2_group_model";
        ...
        try {
            ...
            validate_non_negative_index("len", "nId", nId);
            len = std::vector<int>(nId, int(0));
            ...
            for (int i = 1; i <= nId; ++i) {
                ...
                stan::model::assign(len, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            ((get_base1(end, i, "end", 1) - get_base1(start, i, "start", 1)) + 1), 
                            "assigning variable len");
            }

            // validate transformed data
            current_statement_begin__ = 53;
            size_t len_i_0_max__ = nId;
            for (size_t i_0__ = 0; i_0__ < len_i_0_max__; ++i_0__) {
                check_greater_or_equal(function__, "len[i_0__]", len[i_0__], 0);
            }
    ...
    T__ log_prob(std::vector<T__>& params_r__,
        ...
        try {
            ...
            Eigen::Matrix<local_scalar_t__, 1, Eigen::Dynamic> EdrugObs(nPNObs);
            ...
            Eigen::Matrix<local_scalar_t__, Eigen::Dynamic, Eigen::Dynamic> x(3, nt);
            stan::math::initialize(x, DUMMY_VAR__);
            stan::math::fill(x, DUMMY_VAR__);

            current_statement_begin__ = 92;
            validate_non_negative_index("parms", "nId", nId);
            validate_non_negative_index("parms", "5", 5);
            std::vector<std::vector<local_scalar_t__> > parms(nId, std::vector<local_scalar_t__>(5, local_scalar_t__(0)));
            ...
            for (int j = 1; j <= nId; ++j) {
                ...
                stan::model::assign(parms, 
                            stan::model::cons_list(stan::model::index_uni(j), stan::model::cons_list(stan::model::index_omni(), stan::model::nil_index_list())), 
                            static_cast<std::vector<local_scalar_t__> >(stan::math::array_builder<local_scalar_t__ >().add(get_base1(CL, j, "CL", 1)).add(get_base1(V, j, "V", 1)).add(ke0).add(alpha).add(beta).array()), 
                            "assigning variable parms");
            }
            current_statement_begin__ = 98;
            stan::math::assign(x, pmx_solve_group_rk45(oneCptPNODE_functor__(), 3, len, time, amt, rate, ii, evid, cmt, addl, ss, parms, rep_array(F, nId), rep_array(tLag, nId), 1e-5, 1e-6, 1e5, pstream__));
            current_statement_begin__ = 103;
            for (int i = 1; i <= nPNObs; ++i) {
                current_statement_begin__ = 104;
                stan::model::assign(survObs, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            stan::math::fmax(stan::math::machine_precision(), stan::math::exp(-(get_base1(x, 3, get_base1(iPNObs, i, "iPNObs", 1), "x", 1)))), 
                            "assigning variable survObs");
            }
            current_statement_begin__ = 105;
            stan::math::assign(EdrugObs, multiply(alpha, stan::model::rvalue(x, stan::model::cons_list(stan::model::index_uni(2), stan::model::cons_list(stan::model::index_multi(iPNObs), stan::model::nil_index_list())), "x")));
            ...
            for (int i = 1; i <= nPNCens; ++i) {
                ...
                stan::model::assign(survCens, 
                            stan::model::cons_list(stan::model::index_uni(i), stan::model::nil_index_list()), 
                            stan::math::fmax(stan::math::machine_precision(), stan::math::exp(-(get_base1(x, 3, get_base1(iPNCens, i, "iPNCens", 1), "x", 1)))), 
            ...
            current_statement_begin__ = 92;
            size_t parms_k_0_max__ = nId;
            size_t parms_k_1_max__ = 5;
            for (size_t k_0__ = 0; k_0__ < parms_k_0_max__; ++k_0__) {
                for (size_t k_1__ = 0; k_1__ < parms_k_1_max__; ++k_1__) {
                    if (stan::math::is_uninitialized(parms[k_0__][k_1__])) {
                        std::stringstream msg__;
                        msg__ << "Undefined transformed parameter: parms" << "[" << k_0__ << "]" << "[" << k_1__ << "]";
            ...
            size_t parms_i_0_max__ = nId;
            size_t parms_i_1_max__ = 5;
            for (size_t i_0__ = 0; i_0__ < parms_i_0_max__; ++i_0__) {
                for (size_t i_1__ = 0; i_1__ < parms_i_1_max__; ++i_1__) {
                    check_greater_or_equal(function__, "parms[i_0__][i_1__]", parms[i_0__][i_1__], 0);
                }
            }
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "ttpn2_group_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
        ...
        try {
            ...
            current_statement_begin__ = 88;
            validate_non_negative_index("EdrugObs", "nPNObs", nPNObs);
            Eigen::Matrix<double, 1, Eigen::Dynamic> EdrugObs(nPNObs);
            stan::math::initialize(EdrugObs, DUMMY_VAR__);
            stan::math::fill(EdrugObs, DUMMY_VAR__);
            ...
            validate_non_negative_index("x", "3", 3);
            validate_non_negative_index("x", "nt", nt);
            Eigen::Matrix<double, Eigen::Dynamic, Eigen::Dynamic> x(3, nt);
            stan::math::initialize(x, DUMMY_VAR__);
            stan::math::fill(x, DUMMY_VAR__);
            ...
            validate_non_negative_index("parms", "nId", nId);
            validate_non_negative_index("parms", "5", 5);
            std::vector<std::vector<double> > parms(nId, std::vector<double>(5, double(0)));
            stan::math::initialize(parms, DUMMY_VAR__);
            stan::math::fill(parms, DUMMY_VAR__);
            ...
            if (include_tparams__) {
                ...
                for (size_t k_1__ = 0; k_1__ < parms_k_1_max__; ++k_1__) {
                    for (size_t k_0__ = 0; k_0__ < parms_k_0_max__; ++k_0__) {
                        vars__.push_back(parms[k_0__][k_1__]);
                    }
                }
            }
    ...
    void constrained_param_names(std::vector<std::string>& param_names__,
        ...
        if (include_tparams__) {
            ...
            for (size_t k_1__ = 0; k_1__ < parms_k_1_max__; ++k_1__) {
                for (size_t k_0__ = 0; k_0__ < parms_k_0_max__; ++k_0__) {
                    param_name_stream__.str(std::string());
                    param_name_stream__ << "parms" << '.' << k_0__ + 1 << '.' << k_1__ + 1;
                    param_names__.push_back(param_name_stream__.str());
                }
            }
        }
...
typedef ttpn2_group_model_namespace::ttpn2_group_model stan_model;
